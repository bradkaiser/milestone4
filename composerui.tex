...
\abstract
This paper presents a system for transcribing a whistled or sung melody into
...
\section{INPUT}
Our application aims to take a variety of inputs that are easily produced by most people. This includes whistling, singing, clapping, and snapping. We will allow the user to select between a melody and rhythm mode of input. The ideal case would be to recognize different types of input, i.e. whistling versus clapping, and adjust accordingly, and there is some applicable research \cite{2008Nilsson}, but it is not clear this will be achievable.
