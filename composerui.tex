...
\section{FUTURE WORK}
There are several areas of the application that could be improved with more work. 
First, there is a lot of work that could be done with the note detection component. 
The current system we believe is a good proof of concept, but it would be frustrating to actually try and compose a melody. 
We require that note
